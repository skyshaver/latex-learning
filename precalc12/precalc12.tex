...
\textbf{Formative Assesment} \\
1) For each function \(f(x)\) sketch the graph of i)\(f(-x)\), ii)\(-f(x)\) iii)\(f^{-1}(x)\) \\
Base Points \\ 
\begin{tabular}{|c|c|}
    \hline
    x  & y  \\
...
i) \(f(-x)\) \\
reflection on the y axis, x is inverted \\
\begin{tabular}{|c|c|}
    \hline
    x  & y  \\
    \hline
...
ii) \(-f(x)\) \\
reflection on the x axis, y is inverted \\
\begin{tabular}{|c|c|}
    \hline
    x  & y  \\
    \hline
...
2) Sketch the graph of \(f(x) = \sqrt{25-x^2}\) \\
Base Points \\ 
\begin{tabular}{|c|c|}
    \hline
    x  & y  \\
...
i) \(y = -f(x)\) \\
reflection on the x axis, y is inverted \(y = -\sqrt{25-x^2}\)\\
\begin{tabular}{|c|c|}
    \hline
    x  & y  \\
    \hline
...
ii) \(y = f(-x)\) \\
 \(y = \sqrt{25-(-x)^2}\) which is the same as \(y = \sqrt{25-x^2}\)  \\
\begin{tabular}{|c|c|}
    \hline
    x  & y  \\
     \hline
...
iii) \(x = f(y)\) becomes \(f^{-1}(x)\) an inversion becomes \(y = +/-\sqrt{25-x^2}\)   \\
\begin{tabular}{|c|c|}
    \hline
    x  & y  \\
    \hline
